...
export default function PropertyComparePage() {
  ...
  const [dscrInputs, setDscrInputs] = useState<
    ...
    >
  >({});
  const [fixFlipInputs, setFixFlipInputs] = useState<
    Record<
      string,
      { rehabCost: number; holdingMonths: number; arvPercent: number }
    >
  >({});
          ...
          if (!dscrInputs[id]) {
            ...
            setDscrInputs((prev) => ({
              ...
              [id]: {
                ...
                annualInsurance:
                  data.annualInsurance || Math.round(value * 0.005),
  ...
  function calculateDSCR(propId: string, propertyValue: number): DSCRAnalysis {
    ...
    const totalMonthlyExpenses =
      monthlyDebt + monthlyTaxes + monthlyInsurance + monthlyHoa;
    const dscr =
      annualRent /
      (annualDebt +
        inputs.annualTaxes +
  ...
  function calculateFixFlip(
    ...
    const inputs = fixFlipInputs[propId] || {
      rehabCost: 50000,
      holdingMonths: 6,
      arvPercent: 70,
    };
    ...
    const totalInvestment =
      purchasePrice + rehabCost + holdingCosts + sellingCosts;
    ...
    <div className="container max-w-screen-2xl px-4 md:px-8 py-8 min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Compare properties side by side with profitability analysis
        </p>
      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-green-600">
                          ${property.estEquity?.toLocaleString() || "—"}
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              ...
              >
                {properties.map((property) => {
                  const value =
                    property.attomMarketValue || property.estValue || 500000;
                  const defaultInputs = {
                    rent: estimateRent(value),
                    loanAmount: value * 0.75,
                    rate: 7.5,
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setDscrInputs((prev) => ({
                                ...
                                [property.id]: {
                                  ...inputs,
                                  annualTaxes: Number(e.target.value),
                                },
                              }))
                            }
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setDscrInputs((prev) => ({
                                ...
                                [property.id]: {
                                  ...inputs,
                                  monthlyHoa: Number(e.target.value),
                                },
                              }))
                            }
                      ...
                      <div className="pt-3 border-t space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            ${Math.round(analysis.monthlyDebt).toLocaleString()}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">
            ...
            <CardContent>
              ...
              >
                {properties.map((property) => {
                  const value =
                    property.attomMarketValue || property.estValue || 500000;
                  const inputs = fixFlipInputs[property.id] || {
                    rehabCost: 50000,
                    holdingMonths: 6,
                    arvPercent: 70,
                  };
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFixFlipInputs((prev) => ({
                                ...
                                [property.id]: {
                                  ...inputs,
                                  arvPercent: Number(e.target.value),
                                },
                              }))
                            }
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFixFlipInputs((prev) => ({
                                ...
                                [property.id]: {
                                  ...inputs,
                                  holdingMonths: Number(e.target.value),
                                },
                              }))
                            }

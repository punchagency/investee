            ...
            <TabsContent value="documents" className="pt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload pending items to move to the next stage
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      application.documents.includes(doc) ? (
                        <Badge
                          variant="secondary"
                ...
                <Card className="bg-muted/30 border-dashed">
                  <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-muted-foreground max-w-md">
                      Your application is currently being reviewed. Once
                      preliminary underwriting is complete, your term sheet will
                      appear here.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-primary/20 shadow-lg bg-primary/5">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        toast.success(
                          "Terms Accepted! Moving to final processing."
                        )
                      }
                    >
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Our support team is available 9am - 6pm EST.
              </p>
